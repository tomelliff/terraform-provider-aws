...
func TestAccAWSSpotInstanceRequestInterruptStop(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAWSSpotInstanceRequestInterruptConfigDeprecated("stop"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSSpotInstanceRequestExists(
						"aws_spot_instance_request.foo", &sir),
					resource.TestCheckResourceAttr(
...
func TestAccAWSSpotInstanceRequestInterruptHibernate(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAWSSpotInstanceRequestInterruptConfigDeprecated("hibernate"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSSpotInstanceRequestExists(
						"aws_spot_instance_request.foo", &sir),
					resource.TestCheckResourceAttr(
...
func testAccAWSSpotInstanceRequestInterruptConfigDeprecated(interruptionBehavior string) string {
	return fmt.Sprintf(`
	resource "aws_spot_instance_request" "foo" {
		ami = "ami-19e92861"
		instance_type = "c5.large"
