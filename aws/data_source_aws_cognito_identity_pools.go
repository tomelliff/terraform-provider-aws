...
func dataSourceAwsCognitoIdentityPools() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAwsCognitoIdentityPoolsRead,
...
func dataSourceAwsCognitoIdentityPoolsRead(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*AWSClient).cognitoconn
	name := d.Get("name").(string)

	pools, err := conn.ListIdentityPool(&cognitoidentity.ListIdentityPoolsInput{
